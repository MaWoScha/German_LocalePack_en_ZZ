 ...
 */
class German_LocalePackEnZz_Model_Observer {
    ...
    public function getVersionNumber() {
        ...
        return (string)Mage::app()->getConfig()->getNode('modules/German_LocalePackEnZz/version');
    }
    ...
    public function getManageUrl() {
        return Mage::helper("adminhtml")->getUrl('adminhtml/system_config/edit', array('section'=>'localepackenzz'));
    }
}
